...
import com.datn.studytextscan.ui.home.reward.setupComposeSnackbar
import com.datn.studytextscan.util.collectFlow
import com.datn.studytextscan.util.getColor
import com.datn.studytextscan.util.safeNav
import com.datn.studytextscan.util.showCameraPermissionInfoDialog
import com.datn.studytextscan.util.showSnackbarLongWithAction
import com.datn.studytextscan.util.showSnackbarShort
import com.datn.studytextscan.util.updateWindowInsets
import com.datn.studytextscan.util.viewBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            recyclerViewScans.apply {
                ...
                buttonGoogleDich.setOnClickListener {
                    openInTranslate()
                }
...
//            // Thông báo khi ứng dụng Google Translate chưa được cài đặt
//            Snackbar.make(findViewById(android.R.id.content), "Google Translate chưa được cài đặt.", Snackbar.LENGTH_LONG).show()
//            // Mở trang Play Store để cài đặt Google Translate
//            val playStoreIntent = Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.google.android.apps.translate"))
